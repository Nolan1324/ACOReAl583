...
int main()
{
	...
	for (int j = 0; j < 9900000; j++){ //change j to change benchmark runtime
...
// File Source: https://github.com/c-testsuite/c-testsuite/blob/master/tests/single-exec/00219.c