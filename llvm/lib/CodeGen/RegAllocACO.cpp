...
public:
  RAAco(const RegClassFilterFunc F = allocateAllRegClasses);

  /// Return the pass name.
  StringRef getPassName() const override { return "My Aco Register Allocator"; }
...
RAAco::RAAco(RegClassFilterFunc F):
...
FunctionPass* llvm::createAcoRegisterAllocator(RegClassFilterFunc F) {
  return new RAAco(F);
}
